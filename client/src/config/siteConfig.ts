...
export const galleryImages = [
  {
    ...
    alt: "Exterior view of 24 Kylemount Ave",
    category: "exterior"
  },
  {
    id: 2,
...
export const testimonials = [
  {
    ...
    content: "The open house at 24 Kylemount was exceptionally well-organized. The materials provided gave us a complete understanding of the property and neighborhood.",
...
// Neighborhood stats and amenities
...
export const siteBranding = {
  logoUrl: "/logo.svg",
  logoAlt: "24 Kylemount Ave",
  favicon: "/favicon.ico",
  // Primary colors
  colors: {
    primary: "#D9A566", // Gold accent
    primaryDark: "#8B6839",
    primaryLight: "#E6C38C",
    dark: "#111111",
    light: "#FFFFFF"
  ...
  // Footer info
  footer: {
    copyrightText: "© 2024 24 Kylemount Ave. All rights reserved.",
...
export const siteMetadata = {
  title: "24 Kylemount Ave | Luxury Modern Residence",
  ...
  canonical: "https://24kylemount.com"
};